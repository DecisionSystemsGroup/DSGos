...
_HARDWARE_PATH = '/usr/share/DSGos/DSGos/hardware'
...
class HardwareInstall(object):
    ...
    def __init__(self, use_proprietary_graphic_drivers=False):
        ...
        # This is unsafe, but we don't care if somebody wants DSGos to run code arbitrarily.
        ...
        logging.debug(
            "DSGos will test %d drivers for %d hardware devices",
