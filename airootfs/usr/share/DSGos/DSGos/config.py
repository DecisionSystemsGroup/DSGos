...
""" Configuration module for DSGos """

import multiprocessing


class Settings(object):
    """ Store all DSGos setup options here """
    ...
    def __init__(self):
        ...
        self.settings.put({
            ...
            'btrfs': False,
            'cache': '',
            'DSGos': '/usr/share/DSGos/',
            'country_name': '',
            'country_code': '',
            'data': '/usr/share/DSGos/data/',
            'desktop': 'gnome',
            'desktop_ask': True,
            'desktops': [],
