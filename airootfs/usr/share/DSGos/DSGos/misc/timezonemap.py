...
TIMEZONEMAP_IMAGES_PATH = "/usr/share/DSGos/data/images/timezonemap"
OLSEN_MAP_TIMEZONES_PATH = "/usr/share/DSGos/data/locale/timezones.xml"
...
class TimezoneMap(Gtk.Widget):
    ...
    def do_get_preferred_width(self):
        ...
        # Images are bigger but we need this widget to stay small as DSGos's window
