...
class Language(GtkBaseBox):
    ...
    def translate_ui(self):
        ...
        txt_bold = _("Notice: The DSGos Installer is beta software.")
        # FIXME: Can't use an a html tag in the label. Causes an accessible GTK Assertion
        txt = _("DSGos is pre-release beta software that is under active development. "
        ...
        txt = txt.format("<a href='https://github.com/KGkotzamanidis/DSGos-Installer'>KGkotzamanidis Github</a>")
