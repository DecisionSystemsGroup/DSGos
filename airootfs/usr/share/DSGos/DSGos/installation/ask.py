...
class InstallationAsk(GtkBaseBox):
    def __init__(self, params, prev_page="features", next_page=None):
        ...
        '''
        if enable_alongside:
            msg = "DSGos will enable the 'alongside' installation mode."
        else:
            msg = "DSGos will NOT enable the 'alongside' installation mode."
        logging.debug(msg)
        '''
    ...
    def store_values(self):
        ...
        if must_wait:
            ...
            txt2 = _("DSGos is still updating and optimizing your mirror lists.")
            txt2 += "\n\n"
