...
_HARDWARE_PATH = '/usr/share/DSGos_Installer/DSGos_Installer/hardware'
...
class HardwareInstall(object):
    ...
    def __init__(self, use_proprietary_graphic_drivers=False):
        ...
        # This is unsafe, but we don't care if somebody wants DSGos_Installer to run code arbitrarily.
        ...
        logging.debug(
            "DSGos_Installer will test %d drivers for %d hardware devices",
