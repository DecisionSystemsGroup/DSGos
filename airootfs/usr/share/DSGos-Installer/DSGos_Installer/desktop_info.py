...
FEATURES = {
    'cinnamon': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
                 "office", "smb"],
    'gnome': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
              "office", "smb"],
    'kde4': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
             "office", "smb"],
    'plasma5': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
                "office", "smb"],
    'mate': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "lts", "office", "games", "graphic_drivers", "smb"],
    'enlightenment': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
                      "office", "smb"],
    'base': ["electronic", "computer", "aur", "cups", "fonts", "lamp", "lts"],
    'openbox': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
                "office", "smb", "visual"],
    'lxqt': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
             "office", "smb"],
    'xfce': ["electronic", "computer", "aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts",
             "office", "smb"]}
...
DESCRIPTIONS = {
    ...
    'base': _("This option will install DSGos as command-line only system, "
              "without any type of graphical interface. After the installation you can "
              "customize DSGos by installing packages with the command-line package manager."),
