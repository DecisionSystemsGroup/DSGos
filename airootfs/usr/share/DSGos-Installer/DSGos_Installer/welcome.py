...
class Welcome(GtkBaseBox):
    ...
    def translate_ui(self):
        ...
        if not self.disable_tryit:
            txt = _("Use DSGos without making any changes to your system.") + "\n"
        else:
            txt = ""
        self.labels['tryit'].set_markup(txt)
        self.labels['tryit'].set_name('tryit_label')

        txt = _("Create a permanent place for DSGos on your system.")
        ...
        txt = _("Welcome to DSGos!")
        self.header.set_subtitle(txt)

    def quit_DSGos_Installer(self):
