...
""" Configuration module for DSGos_Installer """

import multiprocessing


class Settings(object):
    """ Store all DSGos_Installer setup options here """
    ...
    def __init__(self):
        ...
        self.settings.put({
            ...
            'btrfs': False,
            'cache': '',
            'DSGos_Installer': '/usr/share/DSGos-Installer/',
            'country_name': '',
            'country_code': '',
            'data': '/usr/share/DSGos-Installer/data/',
            'desktop': 'gnome',
            'desktop_ask': True,
            'desktops': [],
            ...
            'laptop': 'False',
            'locale': '',
            'log_file': '/tmp/DSGos_Installer.log',
            'luks_root_password': "",
            'luks_root_volume': "",
            'luks_root_device': "",
            'partition_mode': 'easy',
            ...
            'tmp': '/tmp',
            'ui': '/usr/share/DSGos-Installer/ui/',
            'use_home': False,
            'use_luks': False,
