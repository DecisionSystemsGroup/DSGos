...
def remove_temp_files():
    """ Remove DSGos_Installer temporary files """
    temp_files = [
        ".setup-running",
        ".km-running",
...
def is_partition_extended(partition):
    ...
    # In automatic LVM volume is called DSGosVG
    if "/dev/DSGosVG" in partition:
        return False
